...
//ploymorphism testing
    ...
    Pieceworker Mypieceworker("Ahmed","Osama","123-456",Date(2,1,1997),12.3,7);
    Hourlyworker Myhourlyworkeremployee("Ahmed","Osama","123-456",Date(2,1,1997),12.3,12);




    vector <Employee *> Differentemployee(5);
    Differentemployee[0]=& MyBasepluscomsissionemployee;
    Differentemployee[1]=& MyComission;
    Differentemployee[2]=& Mysalariedemployee;
    Differentemployee[3]=& Mypieceworker;
    Differentemployee[4]=& Myhourlyworkeremployee;
