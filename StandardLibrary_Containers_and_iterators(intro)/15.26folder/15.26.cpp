...
int main()
{
    ...
    else
    {
        ...
        cout<<"The unique prime factorization of "<<UserInput<<" is: ";
        while(UserInput!=1)
        {
            if(UserInput%2==0)
            {
                UserInput/=2;
                Uniqueprime.append("2");
            }
            else if(UserInput%3==0)
            {
                UserInput/=3;
                Uniqueprime.append("3");
            }
            else if(UserInput%5==0)
            {
                UserInput/=5;
                Uniqueprime.append("5");
            }
            else if(UserInput%7==0)
            {
                UserInput/=7;
                Uniqueprime.append("7");
            }
            else
            {
        ...
        Uniqueprime.erase(Uniqueprime.find_last_of("*"));
        cout<<Uniqueprime;
    }
